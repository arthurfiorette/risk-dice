...
export default function Page() {
  ...
  return (
    <div className="flex flex-col h-screen relative">
      <SideComponent side={Sides.Attack} direction={Direction.Up} isFixed={state === GameState.Finished}/>
      ...
      <SideComponent side={Sides.Defense} direction={Direction.Down} isFixed={state === GameState.Finished}/>
    </div>
  );
}
